...
bi <- sample(bi_model, end_time = end_time, input = input_lst, obs = obs_lst, nsamples = 100, nparticles = minParticles, nthreads = ncores, verbose = T, proposal = 'prior') %>% 
